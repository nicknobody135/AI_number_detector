...
char file_locations_of_training_data[11][36] = {"training_data\\set_a\\0s(a).txt" , "training_data\\set_a\\1s(a).txt" , "training_data\\set_a\\2s(a).txt" , "training_data\\set_a\\3s(a).txt" , "training_data\\set_a\\4s(a).txt" , "training_data\\set_a\\5s(a).txt" , "training_data\\set_a\\6s(a).txt" , "training_data\\set_a\\7s(a).txt" , "training_data\\set_a\\8s(a).txt" , "training_data\\set_a\\9s(a).txt" , "training_data\\set_a\\example.txt"};
FILE *target_file;
